...
const sections = [
  {
    ...
    component: defineAsyncComponent(() => import('./sections/XssIntro.vue')),
  },
  {
  ...
  },
  {
    ...
    component: defineAsyncComponent(() => import('./sections/VariousXss.vue')),
  },
  {
...
// 이전/다음 이동
function goPrevious() {
  router.push({ path: '/xss', query: { sec: currentIndex.value - 1 } })
}
function goNext() {
  router.push({ path: '/xss', query: { sec: currentIndex.value + 1 } })
}
